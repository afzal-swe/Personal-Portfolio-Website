                        ...
                        <div class="p-4">
                            <form method="POST" action="{{ route('about.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="short_title" name="short_title" class="form-control" type="text"  value="{{ old('short_title') }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="short_Description" name="short_Description" required class="form-control" rows="5" placeholder="Please Type Short Description"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="about_image" name="about_image" class="form-control" type="file" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-primary waves-effect waves-light" type="submit">Insert About Page</button>
                                    </div>
                                </div>
