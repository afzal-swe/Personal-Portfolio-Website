    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="p-3">
                        <form method="POST" action="{{ route('website_settings_data.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input name="website_name" class="form-control" type="text" value="{{ $website_setting->website_name ?? 'Null' }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input  id="phone_one" name="phone_one" class="form-control" type="text" value="{{ $website_setting->phone_one ?? 'Null' }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input  id="phone_two" name="phone_two" class="form-control" type="text" value="{{ $website_setting->phone_two ?? 'Null' }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input  id="main_email" name="main_email" class="form-control" type="text" value="{{ $website_setting->main_email ?? 'Null' }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input  id="support_email" name="support_email" class="form-control" type="text" value="{{ $website_setting->support_email ?? 'Null' }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <input  id="address" name="address" class="form-control" type="text" value="{{ $website_setting->address ?? 'Null' }}">
                                </div>
                            </div>
                            <div class="mb-4 row">
                            ...
                            <div class="form-group row mt-3 pt-1">
                                <div class="col-12">
                                    <button class="btn btn-primary waves-effect waves-light" type="submit">Update Website Settings</button>
                                </div>
                            </div>
